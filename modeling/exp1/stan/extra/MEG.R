...
aim <- read_rds("data/clean/exp1/MEG_aims.rds")
...
model <- stan_model(file="modeling/exp1/stan/aim.stan",model_name="MEG")
...
mcmc_est <- sampling(
  ...
  warmup=2500,
  cores=4)
write_rds(mcmc_est,path="modeling/exp1/stan/rds/MEG.rds")
